...
public class TwitterClient extends OAuthBaseClient {
	...
	public void getFollowerList(long userId, long cursor, AsyncHttpResponseHandler handler) {
	...
	public void getFriendsList(long userId, long cursor, AsyncHttpResponseHandler handler) {
